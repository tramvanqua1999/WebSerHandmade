        ...
        <section class="content">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Danh sách đơn hàng đã hủy</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <thead>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tỏng tiền</th>
...
export default {
    ...
    methods: {
        refreshData() {
            let uri = `http://127.0.0.1:8000/api/shop/post/listcancel/${localStorage.getItem('id')}`;
