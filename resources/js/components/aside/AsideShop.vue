   ...
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img v-if="this.datas[0].img != undefined" :src="this.datas[0].img" class="img-circle elevation-2" alt="User Image">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open" @click="itemActive($route.path)" id="select-vue">
            <router-link to="/shop/home" class="nav-link" :class="[(itemA == '/shop/home' || itemA == '/shop/home/transportfee' || itemA == '/block' || itemA == '/unblock') ? 'active':'']">
...
<script>
    export default {
        ...
        methods: {
          ...
          refreshData() {
              let uri = `http://127.0.0.1:8000/api/shop/${localStorage.getItem('id')}`;
